...
datDir<-"C:/Users/Owner/Documents/GitHub/Lysimeter/logger/data/20170710/"
...
ggplot(Dat3[Dat3$DateTime>"2017-07-01"&Dat3$DateTime<"2018-06-21",],aes(x=DateTime,y=BatV))+geom_line()+ylim(12,13)+facet_wrap(~NodeID)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
ggplot(Dat3[Dat3$DateTime>"2017-07-01"&Dat3$DateTime<"2018-06-21",],aes(x=DateTime,y=BoardTemp))+geom_line()+ylim(-10,25)+facet_wrap(~NodeID)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
...
ggplot(Dat3[Dat3$NodeID=='100.2',],aes(x=DateTime,y=diffKg))+geom_line()+ylim(-0.5,0.5)+facet_wrap(~ch)

ggplot(Dat3[Dat3$NodeID=='100.1',],aes(x=DateTime,y=Kg))+geom_point()+ylim(5,20)+facet_wrap(~ch)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
ggplot(Dat3[Dat3$NodeID=='100.2',],aes(x=DateTime,y=Kg))+geom_point()+ylim(5,20)+facet_wrap(~ch)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
ggplot(Dat3[Dat3$NodeID=='100.3',],aes(x=DateTime,y=Kg))+geom_point()+ylim(5,20)+facet_wrap(~ch)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
ggplot(Dat3[Dat3$NodeID=='200.5',],aes(x=DateTime,y=Kg))+geom_point()+ylim(5,20)+facet_wrap(~ch)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
ggplot(Dat3[Dat3$NodeID=='200.6',],aes(x=DateTime,y=Kg))+geom_point()+ylim(5,20)+facet_wrap(~ch)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
ggplot(Dat3[Dat3$NodeID=='100.7',],aes(x=DateTime,y=Kg))+geom_point()+ylim(5,20)+facet_wrap(~ch)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
ggplot(Dat3[Dat3$NodeID=='100.8',],aes(x=DateTime,y=Kg))+geom_point()+ylim(5,20)+facet_wrap(~ch)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
ggplot(Dat3[Dat3$NodeID=='100.9',],aes(x=DateTime,y=Kg))+geom_point()+ylim(5,20)+facet_wrap(~ch)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
ggplot(Dat3[Dat3$NodeID=='100.10',],aes(x=DateTime,y=Kg))+geom_point()+ylim(5,15)+facet_wrap(~ch)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
