...
datDir<-"C:/Users/Owner/Documents/GitHub/Lysimeter/logger/data/20170831/"
...
ggplot(Dat2a[Dat2a$DateTime>"2017-08-12",],aes(x=DateTime,y=BatV))+geom_point()+ylim(11.5,13.2)+facet_wrap(~NodeID)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))+geom_line(aes(y=12.6),color='green')+geom_line(aes(y=11.5),color='red')
...
ggplot(Dat2a[Dat2a$DateTime>="2017-08-10 15:00",],aes(x=DateTime,y=count))+geom_point()+ylim(0,1000)+facet_wrap(~NodeID)+theme(axis.text.x=element_text(angle=30,hjust=1,vjust=1))
...
Datsub<-Dat2a[Dat2a$DateTime>='2017-08-24 15:00',];
