...
long calibration_factor[8] = {55411,55293,54723,55427,55363,55125,1,1};
long zero_factor[8] =        {1270,-16155,21443,20056,11497,50450,1,1};
uint16_t count = 0; //measurement number
uint16_t EEPROM_ADDR = 5; //Start of data storage in EEPROM

/*==============|| TIMING ||==============*/
const uint8_t SLEEP_INTERVAL = 4; //sleep time in minutes
